class OrderAddress
  ...
  def save
    ...
    address = Address.create(postal_code: postal_code, prefecture_id: prefecture_id, city: city, street_num: street_num, building: building, phone_num: phone_num, order_id: order.id)
  end
end